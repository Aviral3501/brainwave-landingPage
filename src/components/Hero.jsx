          ...
          <div className='container relative ' ref={parallaxRef}>
              <div className=' relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem] '>
                  ...
                  <p className=' body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8 '>
                    Unleash the power of AI within Brainwave. Upgrade your productivity with Brainwave, the open AI chat App.
                      The future of communication is here, and it’s powered by artificial intelligence.
                  </p>
                  <Button  href="#pricing" >
                    Get Started
                  </Button>
              ...
              <div className=' relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24 '>
                  <div className='relative z-1  p-0.5 rounded-2xl bg-conic-gradient'>
                      <div className=' relative bg-n-8 rounded-[1rem]'>
                          ...
                          <div className=' aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490] ' >
                              <img src={robot} className='w-full sclae-[1.7] translate-y-[8%]  md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%]'
                  ...
                  <div className='absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 
                    ...
                    height={1800} width={1440} alt="hero"/>
                  </div>
